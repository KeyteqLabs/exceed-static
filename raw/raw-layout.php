		  ...
		  <div class="tab-content">
		    <div class="tab-pane active" id="tab1">
				...
				<ul class="eze-items">
					...
					<li><div class="wrap"><span class="reorder"></span><input type="text" class="name" placeholder="Type a name"><span title="2 Item Manual">2 Item (Manual)</span><div class="right-align"><select class="chzn-select"><option>View</option></select><select class="chzn-select"><option>Set overflow</option></select><a class="btn btn-mini edit-btn" href="">Edit</a><a class="btn btn-mini remove-btn" href="">x</a></div></div></li>
					<li><div class="wrap"><span class="reorder"></span><input type="text" class="name" placeholder="Type a name"><span title="2 Item Manual">Facebook Feed</span><div class="right-align"><select class="chzn-select"><option>View</option></select><select class="chzn-select"><option>Set overflow</option></select><a class="btn btn-mini edit-btn" href="">Edit</a><a class="btn btn-mini remove-btn" href="">x</a></div></div></li>
					<li><div class="wrap"><span class="reorder"></span><input type="text" class="name" placeholder="Type a name"><span title="2 Item Manual">Twitter Feed</span><div class="right-align"><select class="chzn-select"><option>View</option></select><select class="chzn-select"><option>Set overflow</option></select><a class="btn btn-mini edit-btn" href="">Edit</a><a class="btn btn-mini remove-btn" href="">x</a></div></div></li>
					<li><div class="wrap"><span class="reorder"></span><input type="text" class="name" placeholder="Type a name"><span title="2 Item Manual">Article List is really longish</span><div class="right-align"><select class="chzn-select"><option>View</option></select><select class="chzn-select"><option>Set overflow</option></select><a class="btn btn-mini edit-btn" href="">Edit</a><a class="btn btn-mini remove-btn" href="">x</a></div></div></li>
				</ul>
