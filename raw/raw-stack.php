<section class="stack-item first" style="top:0px">
    <header>
        ...
        <button class="close-all go-back focus"><img src="images/icons/stack-close.png" /> Close all</button>
    </header>
	<section class="eze-stack-content">Content here</section>
</section>
<section class="stack-item" style="top:31px">
    <header>
        <h1><div class="iconwrap"><img class="large" src="img/32x32/Documents 32x32.png" /><img class="small" src="img/32x32/Layout 32x32.png" /></div>Second level</h1>
