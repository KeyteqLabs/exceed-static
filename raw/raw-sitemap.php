			...
			<div class="kp-columns" style="width: 423px; ">
				<div class="column ui-droppable" style="height: 1000px; opacity: 1; ">
					<ul class="nodes">
						...
						<li class="node hidden-object ui-draggable ui-droppable"><a id="node-653" class="" data-id="653" data-children="16"><img src="img/32x32/Layout 32x32.png"><span>Solar system</span><i class="has-children-arrow kp-icon16 arrow-right-icon"></i> </a></li>
