		...
		<p>Arrange, add or remove blocks of content inside zones</p>
		  ...
		  <div class="tab-content">
		    <div class="tab-pane active" id="tab1">
				...
				<ul class="eze-items">
					<li><div class="wrap"><p><i class="icon-reorder"></i><input type="text" class="name" placeholder="Type a name"><span title="2 Item Manual">2 Item (Manual)</span></p><select class="chzn-select"><option>Set overflow</option></select><a class="btn btn-mini edit-btn" href="">Edit</a><a class="btn btn-mini remove-btn" href="">x</a></div></li>
					<li><div class="wrap"><p><i class="icon-reorder"></i><input type="text" class="name" placeholder="Type a name"><span title="Facebook Feed">Facebook Feed</span></p><select class="chzn-select"><option>Set overflow</option></select><a class="btn btn-mini edit-btn" href="">Edit</a><a class="btn btn-mini remove-btn" href="">x</a></div></li>
					<li><div class="wrap"><p><i class="icon-reorder"></i><input type="text" class="name" placeholder="Type a name"><span title="Twitter Feed">Twitter Feed</span></p><select class="chzn-select"><option>Set overflow</option></select><a class="btn btn-mini edit-btn" href="">Edit</a><a class="btn btn-mini remove-btn" href="">x</a></div></li>
